...
const navLevels = [
  { label: "L1 — Executive", icon: LayoutDashboard, path: "/", description: "Strategic overview" },
  { label: "L2 — Portfolio", icon: Layers, path: "/portfolio", description: "Cross-product metrics" },
  { label: "L3 — Product", icon: Box, path: "/product", description: "10 product dashboards" },
  { label: "L4 — Team", icon: Users, path: "/team", description: "Team-level detail" },
];
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 p-3 space-y-1">
        <p className={`text-[10px] font-medium uppercase tracking-widest text-sidebar-foreground/60 mb-3 ${collapsed ? "text-center" : "px-3"}`}>
